...
import unittest
from py2casefold import casefold, casefolding_txt_version
...
class TestCasefold(unittest.TestCase):
    ...
    def test_version(self):
        # hardcode version, to make sure it works when CaseFolding.txt
        # is replaced
        self.assertEqual(casefolding_txt_version, "8.0.0")
